...
function Template(props) {
  const { english, russian, tags, transcription, id, editWord, deleteWord } =
    props;
      ...
      <td>
        {isEditing ? (
          <input
            ...
            value={word.english}
            className={
              word.english.trim() === "" ? `${TableAppearance.empty_input}` : ""
            }
          />
        ) : (
      ...
      <td>
        {isEditing ? (
          <input
            ...
            value={word.russian}
            className={
              word.russian.trim() === "" ? `${TableAppearance.empty_input}` : ""
            }
          />
        ) : (
